  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        content: Container(
          ...
          padding:
              const EdgeInsets.all(10), // Agrega padding a todo el contenido
          child: Column(
            mainAxisSize: MainAxisSize.min, // Limita el tamaño a su contenido
            children: [
              const Padding(
                padding:
                    EdgeInsets.symmetric(vertical: 10), // Espaciado vertical
                child: Center(
                    child: Text(
                  "Ya tienes esta tarea en tu lista de tareas te invitamos a editarla. ¿Quieres editarla?",
